...
namespace Primitives {
    ...
    // Cube
    entt::entity CreateCubeObject(entt::registry& registry, const Transform& transform, const Material &material, bool movable=true);
    Mesh CreateCubeMesh(entt::registry &registry);

    // Sphere
    entt::entity CreateUVSphereObject(entt::registry& registry, const Transform& transform, const Material &material, bool movable=true);
